      ...
      <main className="main-content section" id="main-content">
        <div className="container" style={{ maxWidth: "800px" }}>
          ...
          <div className="flex flex-col gap-6" style={{ fontSize: "1.05rem", color: "var(--text-secondary)", lineHeight: "1.75" }}>
            <p>
              <strong>Creators Units</strong> is a modern online toolkit offering 30+ browser-based tools designed to solve daily technical problems for YouTube creators, social media managers, freelancers, students, and small business owners.
            </p>
            ...
            <p>
              We built Creators Units with a different philosophy: privacy-first, client-side execution, and premium design. By running tool computations directly on your computer or mobile device using Javascript and Canvas APIs, we achieve three major milestones:
            </p>
            ...
            <ul style={{ paddingLeft: "1.5rem", display: "flex", flexDirection: "column", gap: "0.5rem" }}>
              ...
              <li><strong>Low Server Maintenance:</strong> Because your device does the heavy lifting, we don&apos;t need heavy backend compute servers. This allows us to keep Creators Units 100% free and fast forever.</li>
            </ul>

            <h2 style={{ fontSize: "1.5rem", color: "var(--text-primary)", marginTop: "1rem" }}>Our Architecture</h2>
            <p>
              Creators Units is built on modern static web standards. By compiling pages statically and dynamically lazy-loading interactive widgets, pages load instantly on slow mobile connections. This makes the platform optimized for Core Web Vitals and search engine indexing.
            </p>

            <p style={{ marginTop: "1.5rem", fontWeight: "600", color: "var(--text-primary)" }}>
              Thank you for using Creators Units. If you have tool suggestions or feedback, please contact us through our contact form.
            </p>
          </div>
