      ...
      <main className="main-content section" id="main-content">
        <div className="container" style={{ maxWidth: "800px" }}>
          ...
          <div className="flex flex-col gap-5" style={{ fontSize: "0.95rem", color: "var(--text-secondary)", lineHeight: "1.75" }}>
            <p>
              Welcome to Creator Units. By accessing and using our website (creatorunits.com) and our browser tools, you agree to comply with and be bound by the following Terms of Service.
            </p>
            ...
            <p>
              Permission is granted to utilize the tools on Creator Units free of charge for personal and commercial use cases (e.g. compressing graphics for your shop, generating secure codes for your business, exporting Link-in-Bio single pages). You may not:
            </p>
            <ul style={{ paddingLeft: "1.5rem", display: "flex", flexDirection: "column", gap: "0.25rem" }}>
              <li>Attempt to decompile, reverse-engineer, or crack the Javascript logic files of Creator Units.</li>
            ...
            <p>
              The materials and tools on Creator Units are provided &quot;as is&quot;. Creator Units makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties, including without limitation, implied warranties of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.
            </p>

            <h2 style={{ fontSize: "1.35rem", color: "var(--text-primary)", marginTop: "1rem", margin: "0" }}>4. Limitations of Liability</h2>
            <p>
              In no event shall Creator Units or its maintainers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the tools on Creator Units, even if Creator Units has been notified orally or in writing of the possibility of such damage.
            </p>

            <h2 style={{ fontSize: "1.35rem", color: "var(--text-primary)", marginTop: "1rem", margin: "0" }}>5. Revisions and Errata</h2>
            <p>
              The materials appearing on Creator Units could include technical, typographical, or photographic errors. Creator Units does not warrant that any of the materials on its website are accurate, complete, or current. Creator Units may make changes to the materials contained on its website at any time without notice.
            </p>
          </div>
        </div>
      </main>
