...
export type ArticleLite = Omit<Article, "content">;

export const articlesIndex: ArticleLite[] = [
  {
  ...
  },
  {
    ...
    "metaDesc": "Instagram recompresses uploads and degrades quality. Learn how to compress and size images correctly before uploading to get the sharpest results.",
  ...
  },
  {
    ...
    "metaDesc": "WebP files are 25–35% smaller than PNG with equal quality. Learn how converting to WebP improves page speed, Core Web Vitals, and Google rankings.",
  ...
  },
  {
    ...
    "metaDesc": "Complete 2025 guide to social media image dimensions. Crop images to the right aspect ratio for Instagram, YouTube, TikTok, LinkedIn, and more.",
  ...
  },
  {
    ...
    "metaDesc": "A technical guide to image optimization for page speed. Covers format selection, compression, lazy loading, responsive images, and CDN delivery.",
  ...
  },
  {
    ...
    "metaDesc": "Learn how to extract exact HEX, RGB, and HSL color codes from any image. Perfect for brand consistency in web design and social media.",
  ...
  },
  {
    ...
    "metaDesc": "Turn raw screenshots into beautiful marketing graphics. Add gradients, shadows, and padding to screenshots for app stores, social media, and pitch decks.",
  ...
  },
  {
    ...
    "metaDesc": "WebP isn't supported everywhere. Learn when to convert WebP back to JPG and how to do it free in your browser without quality loss.",
  ...
  },
  {
    ...
    "metaDesc": "Learn the design principles behind high-CTR YouTube thumbnails. Colors, text, faces, and contrast tips that get more clicks on your videos.",
    ...
    "relatedToolSlugs": [
      ...
      "thumbnail-idea-helper"
    ]
  },
  {
    "slug": "ideal-youtube-thumbnail-size",
    "title": "What is the Ideal YouTube Thumbnail Size in 2025?",
    "metaDesc": "YouTube thumbnail dimensions, file size limits, and aspect ratio requirements explained. Plus how to check your thumbnail meets all specs.",
  ...
  },
  {
    ...
    "metaDesc": "Download YouTube video thumbnails in max resolution, HD, and standard quality. No extensions, no login — works on any video URL.",
  ...
  },
  {
    ...
    "metaDesc": "Extract tags from top-performing YouTube videos and use them to improve your own video SEO. Step-by-step strategy for creators.",
  ...
  },
  {
    ...
    "metaDesc": "Optimize YouTube video titles, descriptions, and tags for maximum search visibility. A comprehensive guide with templates and character count rules.",
  ...
  },
  {
    ...
    "metaDesc": "Design gaming YouTube thumbnails that get clicks. Color palettes, text styles, character placement, and niche-specific tips for gaming creators.",
  ...
  },
  {
    ...
    "metaDesc": "Design high-CTR YouTube thumbnails for tech, programming, and software channels. Clean layouts, color strategy, and text tips for tech creators.",
  ...
  },
  {
    ...
    "metaDesc": "Complete 2025 reference guide for social media image sizes. Instagram, YouTube, Facebook, LinkedIn, TikTok, Twitter/X dimensions and aspect ratios.",
  ...
  },
  {
    ...
    "metaDesc": "Boost your YouTube CTR with proven thumbnail and title strategies. Data-backed tactics that get more viewers clicking on your videos.",
  ...
  },
  {
    ...
    "metaDesc": "Add stylish Unicode fonts to your Instagram bio without any apps. Generate fancy text in bold, italic, cursive, bubble, and more styles free.",
  ...
  },
  {
    ...
    "metaDesc": "Get inspiration for your Instagram bio with 50 creative templates for different creator types: lifestyle, fitness, food, tech, fashion, and more.",
  ...
  },
  {
    ...
    "metaDesc": "Find the best hashtags for Instagram, TikTok, and Twitter posts. Free hashtag generation strategies that actually improve content reach.",
  ...
  },
  {
    ...
    "metaDesc": "Compare Linktree, Beacons, and free alternatives for Instagram link-in-bio pages. Build your own free link-in-bio page with Creator Units.",
  ...
  },
  {
    ...
    "metaDesc": "Know the exact character limits for Twitter, Instagram, LinkedIn, YouTube, and TikTok. Count characters before posting to avoid truncation.",
  ...
  },
  {
    ...
    "metaDesc": "Discover the best fonts for Instagram bios, YouTube banners, and social media profiles. Plus how to use fancy Unicode fonts for free.",
  ...
  },
  {
    ...
    "metaDesc": "Discover 10 creative QR code use cases for small businesses and creators. From business cards to product packaging — practical ideas you can implement today.",
  ...
  },
  {
    ...
    "metaDesc": "Generate secure, random passwords with a free browser-based tool. Learn why strong passwords matter and how to manage them safely.",
  ...
  },
  {
    ...
    "metaDesc": "Learn what URL encoding is, why it matters for web development and SEO, and how to encode/decode URLs free in your browser.",
  ...
  },
  {
    ...
    "metaDesc": "Learn the rules for Title Case, Sentence Case, UPPERCASE, camelCase, and snake_case. Convert text between formats instantly for free.",
  ...
  },
  {
    ...
    "metaDesc": "Track word count, character count, reading time, and sentence count for blog posts, social media, and SEO content. Free browser tool.",
  ...
  },
  {
    ...
    "metaDesc": "Coordinate global teams, schedule live streams, and plan international campaigns with a free time zone converter. Works for any world city.",
  ...
  },
  {
    ...
    "metaDesc": "Discover 20 essential free online tools for content creators. Image compression, QR codes, YouTube thumbnails, password generators, and more.",
  ...
  },
  {
    ...
    "metaDesc": "Compare the best free online image tools for creators. Compressors, converters, crop tools, and color pickers — all tested and ranked.",
  ...
  },
  {
    ...
    "metaDesc": "Discover the best free tools for YouTube creators. Thumbnail preview, tag extractor, size checker, metadata helper — all free and browser-based.",
  ...
  },
  {
    ...
    "metaDesc": "The best free social media tools for growing your audience. Fancy text, hashtag generators, bio builders, WhatsApp links, and link-in-bio pages.",
  ...
  },
  {
    ...
    "metaDesc": "Most free online tools upload your files to external servers. Learn why browser-based tools are more private, faster, and more secure.",
  ...
  },
  {
    ...
    "metaDesc": "Compare browser-based tools vs desktop applications for image editing, content creation, and productivity. Pros, cons, and when to use each.",
  ...
  },
  {
    ...
    "metaDesc": "Understand how image compression works without technical jargon. Why file size matters, how quality settings work, and when to compress images.",
  ...
  },
  {
    ...
    "metaDesc": "The complete free toolkit for solopreneurs and freelancers. Image tools, QR codes, password managers, UTM tracking, and more — all browser-based.",
  ...
  },
  {
    ...
    "metaDesc": "Explore every tool on CreatorUnits.com. Complete guide to all 33 free browser-based tools for images, YouTube, social media, and utilities.",
