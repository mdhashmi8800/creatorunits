...
export const toolDetails: ToolItem = {
  ...
  "faqs": [
    ...
    },
    {
      ...
      "answer": "Hashtags improve reach by index-linking your post to public search pages. They help social media search engines place your content in user recommendation feeds. Targeting relevant, niche-specific tags exposes your graphics to interested audiences, driving organic profile views, new followers, and higher engagement. The right mix of popular and niche tags gives your posts the best chance of being seen."
    },
    {
      "question": "How many hashtags should I use?",
      "answer": "The optimal number of hashtags depends on the platform. While Instagram allows up to 30, design and marketing experts recommend using 5 to 15 highly targeted hashtags to keep captions clean. On platforms like TikTok, LinkedIn, and Twitter, 3 to 5 relevant hashtags work best. Quality always beats quantity—focus on tags that directly relate to your content's theme."
    },
    {
      "question": "Are hashtags still effective?",
      "answer": "Yes, hashtags remain effective for search categorization, search engine indexing, and reaching target demographics. While modern algorithms use machine learning and captions for SEO, hashtags provide clear tags that confirm your post's subject, supporting discoverability in search results pages. They remain one of the simplest organic tools for getting your posts discovered by new audiences."
    }
  ],
