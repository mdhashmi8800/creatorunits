...
export const categories: Record<string, CategoryInfo> = {
  image: {
    ...
    seoTitle: "Free Image Editing & Optimization Tools - Creator Units",
  ...
  creator: {
    ...
    seoTitle: "YouTube Creator Tools & Optimization Utilities - Creator Units",
  ...
  utility: {
    ...
    seoTitle: "Online Utility Tools & Formatting Calculators - Creator Units",
    ...
    seoText: "Tackle standard daily office and web tasks quickly. Creator Units utility tools provide secure cryptographic password generators, URL encoders, UTM tracking link composers, text case formatters, word counter diagnostics, timezone comparisons, and basic unit calculators."
  },
  video: {
    slug: "video",
    name: "Video Tools",
    desc: "Compress video files, extract audio to MP3, grab video thumbnails, and format subtitles.",
    seoTitle: "Free Video Processing and Thumbnail Extraction Tools - Creator Units",
  ...
  pdf: {
    ...
    seoTitle: "Free PDF Utilities - Merge, Split, Protect & Convert PDFs - Creator Units",
    ...
    seoText: "Manage business reports, slides, and legal drafts securely. Creator Units PDF tools operate fully client-side, allowing you to merge files, divide pages, compress sizes, encrypt PDFs with passwords, or convert images to PDFs without ever transmitting sensitive documents online."
  },
  seo: {
    slug: "seo",
    name: "SEO Tools",
    desc: "Generate meta tags, sitemaps, robots.txt, schema scripts, and analyze keyword densities.",
    seoTitle: "Free SEO Tag Generators & Site Validators - Creator Units",
  ...
  developer: {
    ...
    seoTitle: "Developer Utilities - Format, Validate & Minify Code - Creator Units",
    ...
    seoText: "Increase programming productivity. The Creator Units developer toolbox offers instant client-side tools to validate JSON syntax, generate UUID lists, decode JWT payloads, translate Base64 encodings, and minify HTML, CSS, or JS code sizes for faster web deployments."
  },
  business: {
    slug: "business",
    name: "Business Tools",
    desc: "Calculate YouTube/Instagram/TikTok earnings, CPM campaigns, ROI percentages, and profit margins.",
    seoTitle: "Creator Earnings & Business Formulas Calculators - Creator Units",
    ...
    seoText: "Optimize campaigns, track affiliate earnings, and measure business profits. Creator Units business calculators help media buyers, creators, and freelancers calculate campaign CPM/RPM, ROI return rates, profit/discount margins, and estimate channel revenues easily."
  },
  "ai-creator": {
    slug: "ai-creator",
    name: "AI Creator Tools",
    desc: "Generate hooks, scripts, captions, and posts using on-device templates and AI generators.",
    seoTitle: "Free AI Content Creators & Script Generators - Creator Units",
