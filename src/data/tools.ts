...
export const categories: Record<string, CategoryInfo> = {
  image: {
    ...
    seoTitle: "Free Image Editing & Optimization Tools - CreatorUtils",
  ...
  creator: {
    ...
    seoTitle: "YouTube Creator Tools & Optimization Utilities - CreatorUtils",
  ...
  utility: {
    ...
    seoTitle: "Online Utility Tools & Formatting Calculators - CreatorUtils",
    ...
    seoText: "Tackle standard daily office and web tasks quickly. CreatorUtils utility tools provide secure cryptographic password generators, URL encoders, UTM tracking link composers, text case formatters, word counter diagnostics, timezone comparisons, and basic unit calculators."
  }
};
